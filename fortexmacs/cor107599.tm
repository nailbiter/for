...
<\body>
  ...
  <\proof>
    ...
    We that for the Chebyshev polynomials <math|T<rsub|n><around*|(|x|)>> of
    the first kind the following holds:

    <\eqnarray>
      <tformat|<table|<row|<cell|>|<cell|T<rsub|n><around*|(|cos\<varphi\>|)>=cos
      n\<varphi\>,>|<cell|>>|<row|<cell|>|<cell|lim<rsub|\<lambda\>\<rightarrow\>0><around*|(|\<lambda\>+<frac|n|2>|)>\<Gamma\><around*|(|\<lambda\>|)>C<rsub|n><rsup|\<lambda\>><around*|(|x|)>=T<rsub|n><around*|(|x|)>.>|<cell|>>>>
    </eqnarray>

    Using these, and taking <math|\<lambda\>,\<mu\>\<rightarrow\>0> in
    <math|<eqref|eqn:cor:1>> we arrive at:
    ...
    <\eqnarray>
      ...
      mod 2>>>>>><rsup|\<infty\>><frac|2<rsup|2-2\<nu\>>\<Gamma\><around*|(|2\<nu\>+1|)><rsup|2>|\<Gamma\><around*|(|\<nu\>+<frac|l-m|2>+1|)>\<Gamma\><around*|(|1+\<nu\>-<frac|l+m|2>|)>\<Gamma\><around*|(|\<nu\>-<frac|l-m|2>+1|)>\<Gamma\><around*|(|\<nu\>+<frac|l+m|2>+1|)>>T<rsub|l><around*|(|s|)>T<rsub|m><around*|(|s|)>.>|<cell|>>>>
    </eqnarray>
