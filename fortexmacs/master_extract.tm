...
<\body>
  ...
  <math|<block*|<tformat|<table|<row|<cell|<stack|<tformat|<table|<row|<cell|p=1,>>|<row|<cell|q\<in\>2\<bbb-Z\>+1>>>>>>|<cell|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-q/2>,>>|<row|<cell|\<nu\>\<in\>q+2\<bbb-N\>>>>>>>|<cell|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-q/2>,>>|<row|<cell|\<nu\>\<in\>q+1+2\<bbb-N\>>>>>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,>>|<row|<cell|2\<bbb-Z\>\<ni\>\<lambda\>\<leqslant\><frac|q-1|2>>>>>>>>|<cell|<math|0>>|<cell|<math|0>>>|<row|<cell|<stack|<tformat|<table|<row|<cell|\<pi\><rsub|-,n/2-\<lambda\>><rsup|p+1,q+1>,>>|<row|<cell|2\<bbb-Z\>\<ni\>\<lambda\>\<leqslant\><frac|q-1|2>>>>>>>|<cell|<math|0>>|<cell|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>\\\\>>>>>>

  <newline>

  <math|<block*|<tformat|<table|<row|<cell|p,q\<in\>2\<bbb-Z\>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|+,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|\<nu\>\<in\>2\<bbb-N\><rsub|+>>>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|\<nu\>\<in\>2\<bbb-Z\>+1>>>>>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,>>|<row|<cell|2\<bbb-Z\>+1\<ni\>\<lambda\>\<leqslant\>n/2>>>>>>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<in\>\\\\>>|<cell|<math|1\<Leftrightarrow\>\<lambda\>\<gtr\>\<nu\>\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|-,n/2-\<lambda\>>,>>|<row|<cell|2\<bbb-Z\>+1\<ni\>\<lambda\>\<leqslant\>n/2>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>,<around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>><newline>>

  <math|<block*|<tformat|<table|<row|<cell|<stack|<tformat|<table|<row|<cell|p\<in\>2\<bbb-Z\>,>>|<row|<cell|q\<in\>2\<bbb-Z\>+1>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|+,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|2\<bbb-Z\>\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|2\<bbb-Z\>\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>>>>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>2\<bbb-Z\>>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|-,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>n-2\<bbb-N\><rsub|+>>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>>>

  <newline>

  <block*|<tformat|<table|<row|<cell|<stack|<tformat|<table|<row|<cell|<math|p\<in\>2\<bbb-Z\>+1,>>>|<row|<cell|<math|q\<in\>2\<bbb-Z\>>>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|+,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|2\<bbb-Z\>+1\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|2\<bbb-Z\>+1\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>>>>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>n-2\<bbb-N\><rsub|+>>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//\<Leftrightarrow\>\<lambda\>\<gtr\>\<nu\>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|-,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>2\<bbb-Z\>>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>><newline>

  <math|<block*|<tformat|<table|<row|<cell|p,q\<in\>2\<bbb-Z\>+1>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|+,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|\<nu\>\<in\>2\<bbb-Z\>+1>>>>>>>|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-n<rprime|'>/2>,>>|<row|<cell|\<nu\>\<in\>2\<bbb-N\>>>>>>>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>2\<bbb-Z\>,\<lambda\>\<leqslant\>n/2>>>>>>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<in\>\\\\>>|<cell|<math|0>>>|<row|<cell|<math|<stack|<tformat|<table|<row|<cell|\<pi\><rsup|p+1,q+1><rsub|-,n/2-\<lambda\>>,>>|<row|<cell|\<lambda\>\<in\>2\<bbb-Z\>,\<lambda\>\<leqslant\>n/2>>>>>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>>>
