...
<\body>
  ...
  <block*|<tformat|<table|<row|<cell|<math|p=1,q\<in\>2\<bbb-Z\>>>|<cell|<math|T<around*|(|\<nu\>-q|)>,\<nu\>\<in\>q+2\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|T<around*|(|\<nu\>-q|)>,\<nu\>\<in\>q+1+2\<bbb-Z\><rsub|\<geqslant\>0>>>>|<row|<cell|<math|\<pi\><rsub|+,n/2-\<lambda\>><rsup|p+1,q+1>,\<lambda\>\<in\>q-1-2\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|0>>|<cell|<math|0>>>|<row|<cell|<math|\<pi\><rsub|-,n/2-\<lambda\>><rsup|p+1,q+1>,\<lambda\>\<in\>2\<bbb-Z\><rsub|\<leqslant\>0>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>\\\\>>>>>><math|<newline>><math|>

  <math|<block*|<tformat|<table|<row|<cell|p=1,q\<in\>2\<bbb-Z\>+1>|<cell|T<around*|(|\<nu\>-q|)>,\<nu\>\<in\>q+2\<bbb-Z\><rsub|\<geqslant\>0>>|<cell|T<around*|(|\<nu\>-q|)>,\<nu\>\<in\>q+1+2\<bbb-Z\><rsub|\<geqslant\>0>>>|<row|<cell|<math|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,2\<bbb-Z\>\<ni\>\<lambda\>\<leqslant\><frac|q-1|2>>>|<cell|<math|0>>|<cell|<math|0>>>|<row|<cell|\<pi\><rsub|-,n/2-\<lambda\>><rsup|p+1,q+1>,2\<bbb-Z\>\<ni\>\<lambda\>\<leqslant\><frac|q-1|2>>|<cell|<math|0>>|<cell|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>\\\\>>>>>>
  ...
  <math|<block*|<tformat|<table|<row|<cell|p\<in\>2\<bbb-Z\>,q\<in\>2\<bbb-Z\>+1>|<cell|<math|\<pi\><rsup|p,q+1><rsub|+,\<nu\>-n<rprime|'>/2>,2\<bbb-Z\><rsub|\<geqslant\>0>\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>|<cell|<math|\<pi\><rsup|p,q+1><rsub|-,\<nu\>-n<rprime|'>/2>,2\<bbb-Z\><rsub|\<geqslant\>0>\<ni\>\<nu\>\<geqslant\>n<rprime|'>/2>>>|<row|<cell|<math|\<pi\><rsup|p+1,q+1><rsub|+,n/2-\<lambda\>>,\<lambda\>\<in\>2\<bbb-Z\>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//>>>|<row|<cell|<math|\<pi\><rsup|p+1,q+1><rsub|-,n/2-\<lambda\>>,\<lambda\>\<in\>n-2-2\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>>>
