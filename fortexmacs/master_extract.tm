...
<\body>
  ...
  <\eqnarray>
    <tformat|<table|<row|<cell|>|<cell|M\<assign\><around*|{|<around*|[|<tabular*|<tformat|<table|<row|<cell|\<epsilon\>>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|A>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|\<epsilon\>>>>>>|]><mid|\|><stack|<tformat|<table|<row|<cell|A\<in\>O<around|(|p,q|)>>>|<row|<cell|\<epsilon\>=\<pm\>1>>>>>|}>\<supset\>M<rsup|0>\<assign\><around*|{|<around*|[|<tabular*|<tformat|<table|<row|<cell|1>|<cell|0>|<cell|0>>|<row|<cell|0>|<cell|A>|<cell|0>>|<row|<cell|0>|<cell|0>|<cell|1>>>>>|]><mid|\|>A\<in\>O<around|(|p,q|)>|}>>|<cell|>>|<row|<cell|>|<cell|N<rsub|+>\<assign\><around*|{|n<around*|(|w|)>\<assign\>n<rsub|+><around*|(|w|)>\<assign\><around*|[|<tabular|<tformat|<table|<row|<cell|1-<frac|Q<around*|(|w|)>|2>>|<cell|-<around*|(|J
    w|)><rsup|T>>|<cell|<frac|Q<around*|(|w|)>|2>>>|<row|<cell|w>|<cell|I<rsub|p+q>>|<cell|-w>>|<row|<cell|-<frac|Q<around*|(|w|)>|2>>|<cell|-<around*|(|J
    w|)><rsup|T>>|<cell|1+<frac|Q<around*|(|w|)>|2>>>>>>|]><mid|\|>w\<in\>\<bbb-R\><rsup|p,q>|}>\<simeq\>\<bbb-R\><rsup|p,q>>|<cell|>>|<row|<cell|>|<cell|N<rsub|->\<assign\><around*|{|n<rsub|-><around*|(|w|)>\<assign\><around*|[|<tabular|<tformat|<table|<row|<cell|1-<frac|Q<around*|(|w|)>|2>>|<cell|-<around*|(|J
    w|)><rsup|T>>|<cell|-<frac|Q<around*|(|w|)>|2>>>|<row|<cell|w>|<cell|I<rsub|p+q>>|<cell|w>>|<row|<cell|<frac|Q<around*|(|w|)>|2>>|<cell|<around*|(|J
    w|)><rsup|T>>|<cell|1+<frac|Q<around*|(|w|)>|2>>>>>>|]><mid|\|>w\<in\>\<bbb-R\><rsup|p,q>|}>\<simeq\>\<bbb-R\><rsup|p,q>>|<cell|>>|<row|<cell|>|<cell|A\<assign\><mysetn|a<around|(|t|)>\<assign\><around*|[|<tabular*|<tformat|<table|<row|<cell|cosh
    <around|(|t|)>>|<cell|0>|<cell|sinh <around|(|t|)>>>|<row|<cell|0>|<cell|I<rsub|p+q>>|<cell|0>>|<row|<cell|sinh
    <around|(|t|)>>|<cell|0>|<cell|cosh <around|(|t|)>>>>>>|]>|t\<in\>\<bbb-R\>>\<simeq\>\<bbb-R\>.>|<cell|>>>>
  </eqnarray>
  ...
  <\equation*>
    p=1\<Rightarrow\>\<cal-S\>ol<around*|(|\<bbb-R\><rsup|n>;\<lambda\>,\<nu\>|)>=<choice|<tformat|<table|<row|<cell|\<bbb-C\>R<rsup|X><rsub|\<lambda\>,\<nu\>>,>|<cell|<around*|(|\<lambda\>,\<nu\>|)>\<in\>\<bbb-C\><rsup|2>-<around*|(|//\<cap\>\<mid\>\<mid\>\<mid\>|)>-<around*|(|\<mid\>\<mid\>\<cap\>\\\\|)>>>|<row|<cell|\<bbb-C\><wide|R|~><rsup|X><rsub|\<lambda\>,\<nu\>>\<oplus\>\<bbb-C\>R<rsup|<around*|{|0|}>><rsub|\<lambda\>,\<nu\>>,>|<cell|<around*|(|\<lambda\>,\<nu\>|)>\<in\><around*|(|//\<cap\>\<mid\>\<mid\>\<mid\>|)>-<around*|(|\<mid\>\<mid\>\<cap\>\\\\|)>>>|<row|<cell|\<bbb-C\>R<rsup|P><rsub|\<lambda\>,\<nu\>>\<oplus\>\<bbb-C\>R<rsup|C><rsub|\<lambda\>,\<nu\>>,>|<cell|<around*|(|\<lambda\>,\<nu\>|)>\<in\><around*|(|\<mid\>\<mid\>\<cap\>\\\\|)>-
    //>>|<row|<cell|\<bbb-C\>R<rsup|<around*|{|0|}>><rsub|\<lambda\>,\<nu\>>,>|<cell|<around*|(|\<lambda\>,\<nu\>|)>\<in\>\<mid\>\<mid\>\<cap\>\\\\\<cap\>//>>>>>
  </equation*>

  <\equation*>
    p\<gtr\>1\<Rightarrow\>\<cal-S\>ol<around*|(|\<bbb-R\><rsup|n>;\<lambda\>\<comma\>\<nu\>|)>=<choice|<tformat|<table|<row|<cell|\<bbb-C\><wide|R|~><rsup|X><rsub|\<lambda\>,\<nu\>>\<oplus\>\<bbb-C\>R<rsup|<around*|{|0|}>><rsub|\<lambda\>,\<nu\>><rsub|\<lambda\>,\<nu\>>,>|<cell|<around*|(|\<lambda\>,\<nu\>|)>\<in\>
  ...
  <\eqnarray>
    <tformat|<table|<row|<cell|>|<cell|<wide|\<bbb-T\>|~><rsub|n-1-\<nu\>>\<circ\>R<rsup|X><rsub|\<lambda\>,n<rprime|'>-\<nu\>>=q<rsup|T
  ...
  <\eqnarray>
    <tformat|<table|<row|<cell|>|<cell|\<frak-I\>\<assign\><around*|{|*<around*|(|x,y|)>\<in\>\<bbb-Z\><rsub|\<geqslant\>0><rsup|2>\<mid\>x+y\<in\>2\<bbb-Z\>|}>>|<cell|>>|<row|<cell|>|<cell|A<rsup|0><around*|(|a|)>\<assign\><around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>x+y\<leqslant\>a|}>,<space|0.6spc>A<rsup|3><around*|(|a|)>\<assign\><around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>x+y\<gtr\>a|}>>|<cell|>>|<row|<cell|>|<cell|A<rsup|12><around*|(|a|)>\<assign\><around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>-a-p+1\<leqslant\>x-y\<leqslant\>a+q-1|}>,<space|0.6spc>A<rsup|13><around*|(|a|)>\<assign\><around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>x-y\<leqslant\>a+q-1,x+y\<gtr\>a|}>>|<cell|>>|<row|<cell|>|<cell|A<rsup|1><around*|(|a|)>:=<around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>x-y\<gtr\>a+q-1|}>,<space|0.6spc>A<rsup|2><around*|(|a|)>:=<around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>-a-p+1\<gtr\>x-y|}>>|<cell|>>|<row|<cell|>|<cell|A<rsup|123><around*|(|a|)>\<assign\>A<rsup|12><around*|(|a|)>\<cap\>A<rsup|3><around*|(|a|)>,>|<cell|>>|<row|<cell|>|<cell|A<rsup|23><around*|(|a|)>\<assign\><around*|{|<around*|(|x,y|)>\<in\>\<frak-I\><mid|\|>-a-p+1\<leqslant\>x-y,x+y\<gtr\>a|}>>|<cell|>>>>
  </eqnarray>
  ...
  <\enumerate>
    ...
    <center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<leqslant\>0>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|//>>|<cell|<math|\<varnothing\>>>|<cell|<math|\<varnothing\>>>>|<row|<cell|<math|\\\\-//>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|<around*|(|\\\\\<cup\>//|)><rsup|c>>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>>|<row|<cell|CS>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|3><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>\<oplus\>A<rsup|1><around*|(|-\<nu\>|)><rsup|>>>>>>>>

    <center|<block*|<tformat|<table|<row|<cell|<math|0\<less\>\<nu\>\<leqslant\><frac|p+q+1|2>-2>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|full>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|\\\\-
    //>>|<cell|<math|full>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<geqslant\>l>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|irred>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>\<oplus\>A<rsup|1><around*|(|-\<nu\>|)><rsup|>>>>>>>>

    <center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>=<frac|n-1|2>>>|<cell|<math|n\<in\>4\<bbb-Z\>+1\<Leftrightarrow\>\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|n\<in\>4\<bbb-Z\>+3\<Leftrightarrow\>\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|full>>|<cell|<math|A<rsup|2><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k=l><math|>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|irred>>|<cell|<math|A<rsup|2><around*|(|-<frac|n-1|2>|)>\<oplus\>A<rsup|1><around*|(|-<frac|n-1|2>|)>>>>>>>>

    <center|<center|<block*|<tformat|<table|<row|<cell|<math|<frac|n+1|2>\<leqslant\>\<nu\>\<leqslant\><around*|(|n+1|)>-4>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|full>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<less\>l><math|>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|irred>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<oplus\>A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|12><around*|(|\<nu\>-n<rprime|'>|)>>>>>>>>>

    <center|<\center>
      <center|<center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<gtr\><around*|(|n+1|)>-4>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|full>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<less\>l><math|>>|<cell|<math|A<rsup|3><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|\<varnothing\>>>>|<row|<cell|<math|//
      -\\\\>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|A<rsup|3><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|0><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<oplus\>A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|12><around*|(|\<nu\>-n<rprime|'>|)>>>>>>>>>
    </center>>

    <item>Suppose <math|p,q\<in\>2\<bbb-Z\>+1>.

    <center|<center|<center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<leqslant\>0>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|full>>>|<row|<cell|<math|\\\\
    - //><math|>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|\<varnothing\>>>|<cell|<math|full>>>|<row|<cell|CS>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|13><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>>>>>>>>

    <center|<center|<center|<center|<block*|<tformat|<table|<row|<cell|<math|0\<less\>\<nu\>\<leqslant\>p+q-3>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|full>>>|<row|<cell|<math|\\\\
    - //><math|>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|\<varnothing\>>>|<cell|<math|full>>>|<row|<cell|CS>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>>>>>>>>>

    <center|<center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<gtr\>p+q-3>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|full>>>|<row|<cell|<math|\\\\
    - //><math|>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|\<varnothing\>>>|<cell|<math|full>>>|<row|<cell|CS>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|13><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|0><around*|(|\<nu\>-n<rprime|'>|)>>>>>>>>>

    <item>Suppose <math|p,q\<in\>2\<bbb-Z\>>
    (<math|\<Rightarrow\>\\\\\<cap\>//\<cap\><around*|{|\<nu\>\<in\>\<bbb-Z\>|}>=
    \<varnothing\>>)

    <center|<center|<center|<center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<leqslant\>0>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|\\\\
    - //><math|>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|\<varnothing\>>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|23><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>>>>>>>>>>>

    <center|<block*|<tformat|<table|<row|<cell|<math|0\<less\>\<nu\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|full>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|\\\\
    - //><math|>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|full>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>|<cell|<math|<choice|<tformat|<table|<row|<cell|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>,>|<cell|0\<less\>\<nu\>\<leqslant\>n-3>>|<row|<cell|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|23><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|0><around*|(|\<nu\>-n<rprime|'>|)>,>|<cell|n-3\<less\>\<nu\>>>>>>>>>>>>>
    ...
    For <math|\<nu\>\<in\>2\<bbb-Z\>>

    <center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<leqslant\>0>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|\\\\-
    //>>|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<gtr\>l>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<stack|<tformat|<table|<row|<cell|<math|A<rsup|0><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|123><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>\<oplus\>A<rsup|2><around*|(|-\<nu\>|)>>>>>>>>>>>>>

    <center|<block*|<tformat|<table|<row|<cell|<math|0\<less\>\<nu\>\<leqslant\><frac|p+q+1|2>-2>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|2><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|\\\\-
    //>>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<gtr\>l>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|A<rsup|12><around*|(|-\<nu\>|)>\<rightarrow\>A<rsup|1><around*|(|-\<nu\>|)>\<oplus\>A<rsup|2><around*|(|-\<nu\>|)>>>>>>>>

    <center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>=<frac|p+q+1|2>-1>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|2><around*|(|-<frac|n-1|2>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k=l><math|>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|A<rsup|1><around*|(|-<frac|n-1|2>|)>\<oplus\>A<rsup|2><around*|(|-<frac|n-1|2>|)>>>>>>>>

    <center|<center|<block*|<tformat|<table|<row|<cell|<math|<frac|p+q+1|2>\<leqslant\>\<nu\>\<leqslant\><around*|(|p+q+1|)>-4>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<less\>l><math|>>|<cell|<math|\<varnothing\>>>>|<row|<cell|<math|//
    -\\\\>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<stack|<tformat|<table|<row|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<oplus\>A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|\<rightarrow\>A<rsup|12><around*|(|\<nu\>-n<rprime|'>|)>>>>>>>>>>>>>>

    <center|<\center>
      <center|<center|<block*|<tformat|<table|<row|<cell|<math|\<nu\>\<gtr\><around*|(|p+q+1|)>-4>>|<cell|<math|\<nu\>\<in\>2\<bbb-Z\>>>>|<row|<cell|<math|<around*|(|//\<cup\>\\\\|)><rsup|c>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>>>>|<row|<cell|<math|//\<cap\>\\\\,k\<less\>l><math|>>|<cell|<math|\<varnothing\>>>>|<row|<cell|<math|//
      -\\\\>>|<cell|<math|\<varnothing\>>>>|<row|<cell|CS>|<cell|<math|<stack|<tformat|<table|<row|<cell|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>\<oplus\>A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>>>|<row|<cell|A<rsup|123><around*|(|\<nu\>-n<rprime|'>|)>\<rightarrow\>A<rsup|0><around*|(|\<nu\>-n<rprime|'>|)><rsup|>>>>>>>>>>>>>>
    </center>>
  </enumerate>
  ...
  <\math>
    p=1,q\<in\>2\<bbb-Z\>+1\<Rightarrow\><block*|<tformat|<table|<row|<cell|>|<cell|<math|T<around*|(|2m|)>,m\<in\>\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|T<around*|(|2m+1|)>>,m\<in\>\<bbb-Z\><rsub|\<geqslant\>0>>>|<row|<cell|<math|A<rsup|1><around*|(|2l|)>,\<bbb-Z\>\<ni\>l\<geqslant\><frac|q+1|4>>>|<cell|<math|0>>|<cell|<math|0>>>|<row|<cell|<math|A<rsup|2><around*|(|2l|)>,\<bbb-Z\>\<ni\>l\<geqslant\><frac|q+1|4>>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\>\<lambda\>+\<nu\>-q+1\<gtr\>0>>>>>>
  </math>

  <newline>

  <math|p,q\<in\>2\<bbb-Z\>\<Rightarrow\><block*|<tformat|<table|<row|<cell|>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2+2\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2\<bbb-Z\>+1>>>|<row|<cell|<math|A<rsup|1><around*|(|-\<lambda\>|)>,2\<bbb-Z\>+1\<ni\>\<lambda\>\<leqslant\>n/2>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<in\>\\\\>>|<cell|<math|1\<Leftrightarrow\>\<lambda\>\<gtr\>\<nu\>\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//>>>|<row|<cell|<math|A<rsup|2><around*|(|-\<lambda\>|)>,2\<bbb-Z\>+1\<ni\>\<lambda\>\<leqslant\>n/2>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\>n-\<lambda\>-\<nu\>\<less\>0,\<lambda\>-\<nu\>\<leqslant\>0\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>,<around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>><newline>>

  <math|p-q\<in\>2\<bbb-Z\>+1\<Rightarrow\><block*|<tformat|<table|<row|<cell|>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2\<bbb-Z\><rsub|\<geqslant\>0>,\<nu\>\<geqslant\>n<rprime|'>/2>>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2\<bbb-Z\><rsub|\<geqslant\>0>,\<nu\>\<geqslant\>n<rprime|'>/2>>>|<row|<cell|<math|A<rsup|1><around*|(|-\<lambda\>|)>,\<lambda\>\<in\>2\<bbb-Z\>>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<nin\>//\<Leftrightarrow\>\<lambda\>\<gtr\>\<nu\>>>|<cell|<math|0>>>|<row|<cell|<math|A<rsup|2><around*|(|-\<lambda\>|)>,\<lambda\>\<in\>n-2-2\<bbb-Z\><rsub|\<geqslant\>0>>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>|<cell|<math|0>>>>>>><newline><math|p,q\<in\>2\<bbb-Z\>+1\<Rightarrow\><block*|<tformat|<table|<row|<cell|>|<cell|<math|A<rsup|1><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2\<bbb-Z\>+1>>|<cell|<math|A<rsup|2><around*|(|\<nu\>-n<rprime|'>|)>,\<nu\>\<in\>2\<bbb-Z\><rsub|\<gtr\>0>>>>|<row|<cell|<math|A<rsup|1><around*|(|-\<lambda\>|)>,\<lambda\>\<in\>2\<bbb-Z\>,\<lambda\>\<leqslant\>n/2>>|<cell|<math|1\<Leftrightarrow\><around*|(|\<lambda\>,\<nu\>|)>\<in\>\\\\>>|<cell|<math|0>>>|<row|<cell|<math|A<rsup|2><around*|(|-\<lambda\>|)>,\<lambda\>\<in\>2\<bbb-Z\>,\<lambda\>\<leqslant\>n/2>>|<cell|<math|0>>|<cell|<math|1\<Leftrightarrow\><around*|(|n-\<lambda\>,\<nu\>|)>\<in\>//>>>>>>>
