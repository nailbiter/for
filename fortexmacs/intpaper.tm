...
<\body>
  ...
  <\render-proof|Proof of Lemma <reference|lem:Fisum>>
    ...
    <math|<eqref|eqn:iF>=LHS<eqref|eqn:Fijsum>>.

    As <math|<space|0.6spc><rsub|2>F<rsub|1><around*|(|<stack|<tformat|<table|<row|<cell|a,1-a>>|<row|<cell|b>>>>>;<frac|1|2>|)>=<frac|2<rsup|1-b><sqrt|\<pi\>>\<Gamma\><around*|(|b|)>|\<Gamma\><around*|(|<frac|a+b|2>|)>\<Gamma\><around*|(|<frac|b-a+1|2>|)>>>
    (see <cite-detail|andrews2000special|Thm. 5.4> for instance), we can
    continue as

    <\eqnarray>
      <tformat|<table|<row|<cell|>|<cell|<tabular|<tformat|<table|<row|<cell|LHS<eqref|eqn:Fijsum>>|<cell|=<big|sum><rsub|j=0><rsup|\<infty\>><frac|<around*|(|1-d|)><rsub|2j>\<zeta\><rsup|j>|2<rsup|2j>j!<around*|(|b+<frac|1|2>|)><rsub|j>>\<cdot\><frac|2<rsup|1-d+2j><sqrt|\<pi\>>\<Gamma\><around*|(|d-2j|)>|\<Gamma\><around*|(|<frac|a+d|2>-j|)>\<Gamma\><around*|(|<frac|1-a+d|2>-j|)>>>>|<row|<cell|>|<cell|=<frac|2<rsup|1-d><sqrt|\<pi\>>\<Gamma\><around*|(|d|)>|\<Gamma\><around*|(|<frac|a+d|2>|)>\<Gamma\><around*|(|<frac|1-a+d|2>|)>><big|sum><rsub|j=0><rsup|\<infty\>><frac|<around*|(|1-<frac|a+d|2>|)><rsub|j><around*|(|<frac|1+a-d|2>|)><rsub|j>|j!<around*|(|b+<frac|1|2>|)><rsub|j>>\<zeta\><rsup|j>>>>>>>|<cell|>>>>
    </eqnarray>

    where we have used <math|<eqref|eqn:p1>> in the second equality. Hence
    Lemma <reference|lem:Fisum> is proven.
  </render-proof>
...
<\references>
  <\collection>
    ...
    <associate|bib-Selberg:411367|<tuple|7|9>>
    <associate|bib-andrews1999special|<tuple|1|9>>
    <associate|bib-andrews2000special|<tuple|1|9>>
    <associate|bib-dotsenko1985four|<tuple|2|9>>
    <associate|bib-forrester2008importance|<tuple|3|9>>
    <associate|bib-kobayashi2011schrodinger|<tuple|4|9>>
    <associate|bib-kobayashi2015symmetry|<tuple|5|9>>
    <associate|bib-mehta2004random|<tuple|6|9>>
    <associate|bib-rainville1960special|<tuple|7|10>>
    <associate|bib-tarasov2003selberg|<tuple|8|9>>
