...
<\body>
  ...
  the technique we use here is independent of <cite|gelfand1980distribution>.

  We will need a few statements from <cite|hormander1983analysis>, which we
  assume and list below. Of these the first is well-known general fact, while
  other two are computational results.
  ...
  <\enumerate>
    ...
    recurrence relation becomes <math|L <wide|Q|~><rsub|\<pm\>><rsup|\<nu\>+1>=\<pm\>4<wide|Q|~><rsub|\<pm\>><rsup|\<nu\>>>.

    <item>See that these never vanish for <math|n\<in\>2\<bbb-Z\>+1> -- hence
    <math|Q<rsub|\<pm\>><rsup|\<nu\>>> have only at most simple poles at
    points <math|-\<bbb-Z\><rsub|\<geqslant\>1>\<sqcup\><around*|(|-<frac|n|2>-\<bbb-Z\><rsub|\<geqslant\>0>|)>>.
    ...
    be computed for at most simple poles and for at most double poles we can
    compute leading term in Laurent series. Moreover, for at most double
    poles we can also compute residues by inspecting term corresponding to
    <math|\<nu\><rsup|1>> in Taylor expansion of
  ...
  <\proposition>
    ...
    here <math|<around*|[|a|]>> means that for pole at <math|a> highest term
    is supported at <math|<around*|{|Q=0|}>>, while <math|<around*|(|a|)>>
    means that it is supported at <math|<around*|{|0|}>>. Moreover, we mark
    double poles with bold. We note that\ 
  ...
  <\proof>
    ...
    It suffices to show that these extend to holomorphic distributions. Now,
    recurrence equation <math|L Q<rsub|\<pm\>><rsup|\<nu\>+1>=\<pm\>4<around*|(|\<nu\>-1|)><around*|(|\<nu\>+n/2|)>Q<rsub|\<pm\>><rsup|\<nu\>>>
  ...
  <\proof>
    ...
    <math|\<nu\>=-n/2+2,-n/2+1> by lemma <reference|lem-n:odd-holo> and then
    we have <math|<wide|F|~><rsub|-n/2+2><rsup|<around*|(|1/2\<pm\>1/2|)>>=Q<rsub|+><rsup|-n/2+2>\<mp\>Q<rsub|\<nu\>><rsup|-n/2+2>>
  ...
  <\proof>
    ...
    <math|k\<in\>\<bbb-Z\><rsub|\<geqslant\>0>>. And this is granted by lemma
    <reference|lem-n:odd-n/2>.
  </proof>
...
<\references>
  <\collection>
    ...
    <associate|fact-gelfand-n:even|<tuple|4|2>>
    <associate|fact-gelfand-n:odd|<tuple|4|1>>
    <associate|fact-horm-homog|<tuple|1|1>>
    <associate|fact-horm1|<tuple|2|1>>
    <associate|fact-horm2|<tuple|3|1>>
    <associate|fact-horm3|<tuple|7|?>>
    <associate|lem--n:odd-holo|<tuple|25|?>>
    ...
    <associate|lem-n:odd-holo|<tuple|24|6>>
    <associate|lem-n:odd-n/2|<tuple|25|6>>
    <associate|lem-normalized-eq|<tuple|12|2>>
    <associate|lem-pq2holo|<tuple|14|3>>
    <associate|lem-r1|<tuple|18|4>>
    <associate|lem-r1-e|<tuple|15|3>>
    <associate|lem-r1-nonzero|<tuple|20|?>>
    <associate|lem-r2|<tuple|20|5>>
    <associate|lem-r3|<tuple|21|5>>
    <associate|lem-r4|<tuple|19|4>>
    ...
    <associate|lem-restricted|<tuple|7|2>>
    <associate|prop-1|<tuple|4|1>>
    <associate|prop-2|<tuple|5|1>>
  </collection>
</references>
