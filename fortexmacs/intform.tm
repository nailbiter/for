...
<\body>
  ...
  <\proposition>
    ...
    <\eqnarray>
      <tformat|<table|<row|<cell|>|<cell|<big|int><rsub|0><rsup|1><around*|(|1-w<rsup|2>|)><rsup|\<alpha\>>w<rsup|\<beta\>><around*|\||1-u
      w|\|><rsup|\<gamma\>>d w=>|<cell|>>|<row|<cell|>|<cell|<frac|u<rsup|-\<beta\>-1>\<Gamma\><around*|(|\<gamma\>+1|)>\<Gamma\><around*|(|\<alpha\>+\<beta\>+1|)>|\<Gamma\><around*|(|\<alpha\>+\<beta\>+\<gamma\>+2|)>>
      <rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|-\<alpha\>,<frac|\<alpha\>+\<beta\>+1|2>,<frac|\<alpha\>+\<beta\>+2|2>>>|<row|<cell|<frac|\<alpha\>+\<beta\>+\<gamma\>+2|2>,<frac|\<alpha\>+\<beta\>+\<gamma\>+3|2>>>>>>;u<rsup|-2>|)>+>|<cell|>>|<row|<cell|>|<cell|u<rsup|-\<beta\>-1>B<around*|(|-\<beta\>-\<gamma\>-1,\<gamma\>+1|)><rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|<frac|\<beta\>+1|2>,<frac|\<beta\>+2|2>,-\<alpha\>>>|<row|<cell|<frac|2+\<beta\>+\<gamma\>|2>,<frac|3+\<beta\>+\<gamma\>|2>>>>>>;u<rsup|-2>|)>->|<cell|>>|<row|<cell|>|<cell|-u<rsup|\<gamma\>>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>+1|2>|)>
      <rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|-<frac|\<gamma\>|2>,<frac|1-\<gamma\>|2>,<frac|-1-2\<alpha\>-\<beta\>-\<gamma\>|2>>>|<row|<cell|>>|<row|<cell|<frac|1|2>,<frac|1-\<beta\>-\<gamma\>|2>>>>>>;u<rsup|-2>|)>+>|<cell|>>|<row|<cell|>|<cell|<frac|u<rsup|\<gamma\>-1>|\<gamma\>>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>|2>|)>
      <rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|<frac|1-\<gamma\>|2>,<frac|2-\<gamma\>|2>,<frac|-2\<alpha\>-\<beta\>-\<gamma\>|2>>>|<row|<cell|<frac|3|2>,<frac|2-\<beta\>-\<gamma\>|2>>>>>>;u<rsup|-2>|)>.>|<cell|>>>>
    </eqnarray>
  </proposition>
  ...
  <\render-proof|Proof of Proposition <reference|prop-2>>
    ...
    <\eqnarray>
      ...
      w=>|<cell|>>|<row|<cell|>|<cell|=u<rsup|-\<beta\>-1><around*|[|<big|int><rsub|0><rsup|1><around*|(|1-<frac|1|w<rsup|2>u<rsup|2>>|)><rsup|\<alpha\>>w<rsup|-\<beta\>-\<gamma\>-2><around*|(|1-w|)><rsup|\<gamma\>>d
      w-<big|int><rsub|0><rsup|1/u><around*|(|1-<frac|1|w<rsup|2>u<rsup|2>>|)><rsup|\<alpha\>>w<rsup|-\<beta\>-\<gamma\>-2><around*|(|1-w|)><rsup|\<gamma\>>d
      w|]>=>|<cell|>>|<row|<cell|>|<cell|u<rsup|-\<beta\>-1><around*|[|<big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<alpha\>|)><rsub|n>|n!>B<around*|(|-2n-\<beta\>-\<gamma\>-1,\<gamma\>+1|)>u<rsup|-2n>-u<rsup|\<beta\>+\<gamma\>+1><big|int><rsub|0><rsup|1><around*|(|1-w<rsup|-2>|)><rsup|\<alpha\>>w<rsup|-\<beta\>-\<gamma\>-2><around*|(|1-<frac|w|u>|)><rsup|\<gamma\>>d
      w|]>=>|<cell|>>|<row|<cell|>|<cell|=u<rsup|-\<beta\>-1>B<around*|(|-\<beta\>-\<gamma\>-1,\<gamma\>+1|)><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<alpha\>|)><rsub|n>|n!><frac|<around*|(|1+\<beta\>|)><rsub|2n>|<around*|(|2+\<beta\>+\<gamma\>|)><rsub|2n>>u<rsup|-2n>->|<cell|>>|<row|<cell|>|<cell|-u<rsup|\<gamma\>><big|int><rsub|0><rsup|1><around*|(|1-w<rsup|2>|)><rsup|\<alpha\>>w<rsup|\<beta\>+\<gamma\>><around*|(|1-<frac|1|w
      u>|)><rsup|\<gamma\>>d w=>|<cell|>>|<row|<cell|>|<cell|<around*|(|\<frak-A\>\<assign\>u<rsup|-\<beta\>-1>B<around*|(|-\<beta\>-\<gamma\>-1,\<gamma\>+1|)><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<alpha\>|)><rsub|n>|n!><frac|<around*|(|1+\<beta\>|)><rsub|2n>|<around*|(|2+\<beta\>+\<gamma\>|)><rsub|2n>>u<rsup|-2n>|)>>|<cell|>>|<row|<cell|>|<cell|\<frak-A\>-u<rsup|\<gamma\>><big|int><rsub|0><rsup|1><around*|(|1-w|)><rsup|\<alpha\>>w<rsup|<frac|\<beta\>+\<gamma\>-1|2>><around*|(|1-<frac|w<rsup|-1/2>|u>|)><rsup|\<gamma\>>
      d w=>|<cell|>>|<row|<cell|>|<cell|\<frak-A\>-u<rsup|\<gamma\>><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<gamma\>|)><rsub|n>|n!>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>+1-n|2>|)>u<rsup|-n>=>|<cell|>>|<row|<cell|>|<cell|u<rsup|-\<beta\>-1>B<around*|(|-\<beta\>-\<gamma\>-1,\<gamma\>+1|)><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<alpha\>|)><rsub|n>|n!><frac|<around*|(|<frac|\<beta\>+1|2>|)><rsub|n><around*|(|<frac|\<beta\>+2|2>|)><rsub|n>|<around*|(|<frac|2+\<beta\>+\<gamma\>|2>|)><rsub|n><around*|(|<frac|3+\<beta\>+\<gamma\>|2>|)><rsub|n>>u<rsup|-2n>->|<cell|>>|<row|<cell|>|<cell|-u<rsup|\<gamma\>>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>+1|2>|)><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<gamma\>|)><rsub|2n>|<around*|(|1|)><rsub|2n>><frac|<around*|(|<frac|-1-2\<alpha\>-\<beta\>-\<gamma\>|2>|)><rsub|n>|<around*|(|<frac|1-\<beta\>-\<gamma\>|2>|)><rsub|n>>u<rsup|-2n>->|<cell|>>|<row|<cell|>|<cell|-u<rsup|\<gamma\>-1>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>|2>|)><big|sum><rsub|n\<geqslant\>0><frac|<around*|(|-\<gamma\>|)><rsub|2n+1>|<around*|(|1|)><rsub|2n+1>>\<cdot\><frac|<around*|(|<frac|-2\<alpha\>-\<beta\>-\<gamma\>|2>|)><rsub|n>|<around*|(|<frac|2-\<beta\>-\<gamma\>|2>|)><rsub|n>>u<rsup|-2n>=>|<cell|>>|<row|<cell|>|<cell|u<rsup|-\<beta\>-1>B<around*|(|-\<beta\>-\<gamma\>-1,\<gamma\>+1|)><rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|<frac|\<beta\>+1|2>,<frac|\<beta\>+2|2>,-\<alpha\>>>|<row|<cell|<frac|2+\<beta\>+\<gamma\>|2>,<frac|3+\<beta\>+\<gamma\>|2>>>>>>;u<rsup|-2>|)>->|<cell|>>|<row|<cell|>|<cell|-u<rsup|\<gamma\>>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>+1|2>|)>
      <rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|-<frac|\<gamma\>|2>,<frac|1-\<gamma\>|2>,<frac|-1-2\<alpha\>-\<beta\>-\<gamma\>|2>>>|<row|<cell|>>|<row|<cell|<frac|1|2>,<frac|1-\<beta\>-\<gamma\>|2>>>>>>;u<rsup|-2>|)>+>|<cell|>>|<row|<cell|>|<cell|<frac|u<rsup|\<gamma\>-1>|\<gamma\>>B<around*|(|\<alpha\>+1,<frac|\<beta\>+\<gamma\>|2>|)>
      <rsub|3>F<rsub|2><around*|(|<stack|<tformat|<table|<row|<cell|<frac|1-\<gamma\>|2>,<frac|2-\<gamma\>|2>,<frac|-2\<alpha\>-\<beta\>-\<gamma\>|2>>>|<row|<cell|<frac|3|2>,<frac|2-\<beta\>-\<gamma\>|2>>>>>>;u<rsup|-2>|)>.>|<cell|>>>>
    </eqnarray>
  </render-proof>
