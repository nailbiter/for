...
\usepackage[top=0.2in,bottom=0.0in,left=0.0in,right=0.3in]{geometry}
\usepackage[russian,english]{babel} % національна локалізація; може бути декілька
\usepackage{setspace}
\usepackage{CJKutf8}
\usepackage{mdframed}
\usepackage{setspace}
\title{\vspace{-6ex}Divine Liturgy\vspace{-0.5ex}\\Reading from The Epistles\vspace{-1.5ex}}
\author{\vspace{-1ex}Week 19 after the Pentecost\vspace{
-3ex%for author
}}
\date{\vspace{
-9ex%for date
