...
\usepackage[top=0.1in,bottom=0.0in,left=-0.1in,right=0.3in]{geometry}
\usepackage[russian,english]{babel} % національна локалізація; може бути декілька
\usepackage{setspace}
\usepackage{CJKutf8}
\usepackage{mdframed}
\usepackage{setspace}
\title{\vspace{-4ex}Divine Liturgy\\Reading from The Epistles}
\author{\vspace{-5ex}Week 2 after the Pentecost (memorial reading)\vspace{
-11ex%for author
}}
\date{\vspace{
-8ex%for date
