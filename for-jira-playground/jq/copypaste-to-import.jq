...
[[.|split("\n")|to_entries|.[]|{n:(.key/3)|trunc,v:.value}]|group_by(.n)|.[]|{summary:.[-2].v,original_time_estimate_minutes:.[-2].v,original_time_estimate_minutes:(.[-1].v[:-3]|tonumber), issue_type_id:10011,project_id:"10005",parent_id:"JC-54",}]
