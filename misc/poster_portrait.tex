...
\mybox{This work concerns:}{
	...
	\begin{enumerate}
		...
		\item[($\mathcal{C}$5)] Ker and Image of SBOs.
	\end{enumerate}
}
 }
 \newcommand{\tikzcone}[1]{
...
\end{tikzpicture}
 ...
 \headerbox{Setting}{name=problem,column=0,below=setting}
 {
	 \begin{equation*}
		 \begin{array}{@{}c@{}cl}
 &(G,G')=&\\
 &\left( O(n+1,1),O(n,1) \right)\mbox{\;\cite{kobayashi2015symmetry}}&\mbox{first {\bf complete}}\\
 &&\mbox{ answer to ($\mathcal{C}2$)}\\
 \implies&\left( O(p+1,q),O(p,q) \right)\mbox{\textsc{\;Goal}}&
 \end{array}
	 \end{equation*}
	 \tikzcone{0.3}
 }
