...
\begin{frame}{Advantages}
	\begin{itemize}
		...
		\item Can choose particular basis to suit the particular problem domain (i.e. Hermitian for medical imaging);\pause
		\item Error estimation is readily available ($\implies$ can estimate convergence speed);
	\end{itemize}
\end{frame}
