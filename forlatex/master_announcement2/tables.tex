...
{\pipx}		{0}
{\pimx}		{g\kern-0.1cm\left( {y-x+{1}/{2}} \right)}
	\item $p=1,q\in2\Z+1$\\
...
{}	{\pipy}				{\pimy}
{\pipx}	{g\kern-0.1cm\left({x-y+1/2}\right)} 	{0}
{\pipx}	{0} 				{g\kern-0.1cm\left( {y-x}+\frac{1}{2} \right)}
\item $p\in2\Z,q\in2\Z+1$\\
\commonShift\mytable	%4
{}	{\pipy}	{\pimy}
{\pipx} {0}	{g\kern-0.1cm\left( {1/2-x-y} \right)}
{\pimx} {0} 	{g\kern-0.1cm\left( {y-x+1/2} \right)}
