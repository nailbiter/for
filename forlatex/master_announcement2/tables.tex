...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{enumerate}[(1)]
	\item $p=1,q\in2\Z$\myfootnote{the requirement $y\ge q/2$ in this and next item is not necessary.
			Note that without it, $\pi_{-,y}^{1,q+1}$ will span the whole $J(\nu)$. I remember that I made computations for this case,
			however I will have to redo them, perhaps, as I did not include them in \texttt{master_streamline.pdf}. It will take about 1 day. Should I better do this?}\\
