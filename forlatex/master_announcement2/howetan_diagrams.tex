...
{\begin{lpic}[draft]{howetan2d30(0.5)}
		...
		\lbl[bl]{9.4,-10; $\bullet$}
		\lbl[bl]{13.8,-11; \scriptsize$ 2-a-q =\lambda+\frac{p-q}{2}+1= b\left( \lambda,q,p \right)$}
		\lbl[bl]{71,21; \scriptsize$ =-\lambda-\frac{p-q}{2}-1=-b\left( \lambda,q,p \right)$}
		

%%		\lbl[bl]{25,70; \makebox[3cm]{\dotfill}}
%%		\lbl[bl]{25,65; \makebox[3cm]{\hrulefill}}
%%		\lbl[bl]{25,65; \hdashrule[0.5ex]{3cm}{1pt}{3mm}}
	\end{lpic}}\vspace{2em}
	&
	...
	&{\begin{tabular}[]{c}
		...
		$\left( a+q-2,0 \right)=\left( ,0 \right)$\\
		$=\left( ,0 \right)$
