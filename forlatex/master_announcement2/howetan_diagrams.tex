...
\begin{tabular}[]{c|c|c}
	...
	\end{array}$
	&affected by $A^{+\pm}$ (i.e. $\varepsilon=(-1)^a=(-1)^{b(\lambda,q,p)}$)&affected by $A^{-\pm}$ (i.e. $\varepsilon=(-1)^{a+1}=(-1)^{b(\lambda,p,q)}$)\\
	\hline\\
	 $\begin{array}[]{c}
	a\in\N\iff\\
...
\begin{tabular}[]{@{}c@{}|c|c}
	$\begin{array}[]{c}
		\lambda=\\-a-\frac{p+q}{2}+1
	\end{array}$
	&$\begin{array}[]{c}\mbox{affected by }A^{+\pm}\\ \mbox{(i.e. $\varepsilon=(-1)^a=(-1)^{b(\lambda,q,p)}$)}\end{array}$&affected by $A^{-\pm}$ (i.e. $\varepsilon=(-1)^{a+1}=(-1)^{b(\lambda,p,q)}$)\\
	\hline\\
	 $\begin{array}[]{c}
	-\N_+\ni a\ge4-(p+q)\iff\\
	1-\frac{p+q}{2}<\lambda\le\frac{p+q}{2}-3\mid \lambda\in\frac{1}{2}+\Z
\end{array}$&
