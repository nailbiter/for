	...
	\begin{enumerate}[(1)]
		\item Suppose that $x\ge y-\frac{1}{2}$.\begin{enumerate}
				\item [(1-a)] Assume $x-y-\frac{1}{2}\in2\Z$. Then
					\begin{equation*}
						\begin{array}[]{c}
						\Hom_{G'}\left( \mypit{x-\frac{n}{2}}\mid_{G'},\mypitp{y-\frac{n-1}{2}} \right)=1,\\
%%						\Hom_{G'}\left( \mypit{x-\frac{n}{2}}\mid_{G'},\mypifp{y-\frac{n-1}{2}} \right)=0,\\
%%						\Hom_{G'}\left( \mypif{x-\frac{n}{2}}\mid_{G'},\mypifp{y-\frac{n-1}{2}} \right)=1.
						\end{array}
					\end{equation*}
				\item [(1-b)] Assume $x-y+\frac{1}{2}\in2\Z$. Then
					\begin{equation*}
						\begin{array}[]{c}
						\Hom_{G'}\left( \mypit{x-\frac{n}{2}}\mid_{G'},\mypitp{y-\frac{n-1}{2}} \right)=0,\\
%%						\Hom_{G'}\left( \mypit{x-\frac{n}{2}}\mid_{G'},\mypifp{y-\frac{n-1}{2}} \right)=1,\\
%%						\Hom_{G'}\left( \mypif{x-\frac{n}{2}}\mid_{G'},\mypifp{y-\frac{n-1}{2}} \right)=0.
						\end{array}
					\end{equation*}
			\end{enumerate}
