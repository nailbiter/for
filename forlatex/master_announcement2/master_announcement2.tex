	...
	\begin{enumerate}[(1)]
		\item Suppose that $i\ge j$.\begin{enumerate}
				\item [(1-a)] Assume $i\equiv j\mbox{ mod 2}$. Then
					\begin{equation*}
						\begin{array}[]{c}
						\Hom_{G'}\left( \mypit{i}\mid_{G'},\mypitp{j} \right)=1,\\ \Hom_{G'}\left( \mypit{i}\mid_{G'},\mypifp{j} \right)=0,\\
				...
				\item [(1-b)] Assume $i\equiv j\mbox{ mod 2}$. Then
					\begin{equation*}
						\begin{array}[]{c}
						\Hom_{G'}\left( \mypit{i}\mid_{G'},\mypitp{j} \right)=0,\\ \Hom_{G'}\left( \mypit{i}\mid_{G'},\mypifp{j} \right)=1,\\
