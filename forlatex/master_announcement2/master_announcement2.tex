...
for any $\lambda\in A_0(p,q)$ each of the following 5 conditions defines uniquely a $(\mathfrak{g},K)$-module, which are mutually isomorphic. We shall denote
...
\begin{equation*}
	...
	\end{array}
\end{equation*}
Now, for $x\in \Bzeven(p,q)$ direct check (cf. \cite{howe1993homogeneous})
\end{definition}
