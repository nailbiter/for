...
\begin{definition}[$Y_{\pm,\lambda}^{p,q}$]\label{def:Y}
	Let $p,q\in\N_+$. We define the parameter set $B(p,q)$ as\myfootnote{I still working on this definition, I will fix it till the end of today}
\begin{equation*}
...
\begin{remark}
	...
	\cite[Thm. 3.3]{kobayashi93restriction} is in fact stronger than the statement we can read off Theorem \cite{thm:Aq}:
