...
%%	Let $i\in\N$. For the infinite-dimensional modules $T(i)$ introduced in \cite{kobayashi2015symmetry}, 
%%	in Prop 16.1 of the same book, the following isomorphism of $\left( \mathfrak{o}(n+1,1),O(n+1)\times O(1) \right)$-modules was shown:\begin{equation*}
%%		T(i)_K\simeq \pi^{n+1,1}_{+,\frac{n}{2}+i}.
%%	\end{equation*}
%%	Using this identification, the Theorem 1.2 of \cite{kobayashi2015symmetry} can be rewritten as follows:
%%	\begin{enumerate}[(1)]
