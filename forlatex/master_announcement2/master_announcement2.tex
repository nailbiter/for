...
\begin{enumerate}
	\item[(i)] A subrepresentation of
		...
		with $K$-type\myfootnote{in on of the previous revisions<++>}\begin{equation*}
			\begin{array}[]{c}
...
%%			\varepsilon\equiv\varepsilon(\lambda,p,q):=(-1)^b.
	...
	\item[(i)$'$] A\myfootnote{In previous revision, You said that the previous item was ``Wrong''. I did not quite get the reason\ldots Is it still wrong?
			{\it I keep this because in one of
			previous revisions mails in reply to this footnote You replied ``Footnote 2, what is the difference between Y and pi?''.
