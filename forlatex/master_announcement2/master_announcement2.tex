...
irreducible unitary representations $\pi_{+,\lambda}^{p,q}$ of $O(p,q)$\myfootnote{should I mention that parametrization in \cite{KO2} and in our case are different?}:
\begin{enumerate}
