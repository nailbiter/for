...
%%			\varepsilon\equiv\varepsilon(\lambda,p,q):=(-1)^b.
	...
	\item[(i)$'$] A\myfootnote{In previous revision, You said that the previous item was ``Wrong''. I did not quite get the reason\ldots Is it still wrong?
			{\it I keep this because in one of the
			previous mails in reply to this footnote You replied ``Footnote 2, what is the difference between Y and pi?''.
			Since I still cannot answer this question, I keep footnote as a reminder to myself.
		}} quotient of $\Ind_{P^{\scalebox{0.5}{$\max$}}}^G\left( \varepsilon\otimes\C_{-\lambda} \right)$ with $K$-type $\Sigma(K:b)$.
\end{enumerate}
