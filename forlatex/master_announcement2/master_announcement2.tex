...
%%(the latter corresponds to the $q=0$ case of the former.
	For the infinite-dimensional modules $T(i)$ ($i\in\N$) introduced in \cite{kobayashi2015symmetry}, 
	...
	$\left( \mathfrak{o}(n+1,1),O(n+1)\times O(1) \right)$-modules is easy to observe\myfootnote{should I elaborate here?}:\begin{equation*}
		%TODO
	\end{equation*}
