	...
	\begin{enumerate}[(1)]
		\item Suppose that $i\ge j$.\begin{enumerate}
				\item [(1-a)] Assume $i\equiv j\mbox{ mod 2}$. Then
					\begin{equation*}
						\begin{array}[]{c}
						m\left( \mypit{i},\mypitp{j} \right)=1,\\ m\left( \mypit{i},\mypifp{j} \right)=0,\\
						m\left( \mypif{i},\mypifp{j} \right)=1.
						\end{array}
					\end{equation*}
				\item [(1-b)] Assume $i\equiv j\mbox{ mod 2}$. Then
					\begin{equation*}
						\begin{array}[]{c}
						m\left( \mypit{i},\mypitp{j} \right)=0,\\ m\left( \mypit{i},\mypifp{j} \right)=1,\\
						m\left( \mypif{i},\mypifp{j} \right)=0.
						\end{array}
					\end{equation*}
			\end{enumerate}
		\item Suppose that $i<j$. Then
			\begin{equation*}
				\begin{array}[]{c}
				m\left( \mypit{i},\mypitp{j} \right)=0,\\
				m\left( \mypit{i},\mypifp{j} \right)=1,\\
				m\left( \mypif{i},\mypifp{j} \right)=0.
				\end{array}
			\end{equation*}
	\end{enumerate}
