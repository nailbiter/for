...
\begin{question}
	\begin{enumerate}[(1)]
		\item 原点が最大になる（もちろん、極大にもなる）:\begin{equation*}
			...
			\end{equation*}
			になるので、yは０と等しくなかったら、$f(x,y)\le-2y^2<0=f(0,0)$になる。更に、$y$が０と等しくて、xは０て等しくでなかったら、
			$f(x,y)=-x^2<0$になる。
		\item 原点が極大にならない（もちろん、最大にもならない）:\begin{equation*}
				f(x,y)=-x^2+3xy-2y^2=-\left( x-\frac{3}{2}y \right)^2+\frac{1}{4}y^2
			\end{equation*}
			になるので、$(x_n,y_n):=\left( \frac{3}{2n},\frac{1}{2n} \right)$ が原点に近づくが、$f(x_n,y_y)<0=f(0,0)$である。
	\end{enumerate}
\end{question}
\begin{question}
	\begin{enumerate}[(1)]
		\item 原点が極小にならない（もちろん、最小にもならない）:\begin{equation*}
			\end{equation*}
	\end{enumerate}
\end{question}<++>
\begin{question}
