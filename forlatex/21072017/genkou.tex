...
エルミート多項式$\left\{ H_n \right\}_{n=1}^\infty$は、
	...
	\begin{fact*}[Mehta積分, {\cite{mehta2004random}}]
		...
		\myrelationdiagram{A}{B}{C}{D}{E}
%%		\centerline{
%%		\xymatrix{
%%			\frame{\mbox{系1}}\ar@{=>}[rd]^{\begin{array}[]{c}
%%			w=-1,\\\ell=m=0
%%		\end{array}}&&\frame{\mbox{Mehta積分}}\ar@{=>}[ld]_{\begin{array}[]{c}
%%		k=2
%%	\end{array}}\\
%%			&
%%			\frame{\mbox{$\int_{-\infty}^\infty\int_{-\infty}^\infty\myabs{x-y}^{2\nu}e^{-x^2-y^2}dxdy=\mypgf$}}
%%			&
%%		}}
