...
\begin{frame}[fragile]
	...
	\begin{textblock*}{0.5\textwidth}(-0.2cm,-2.4cm)
		...
		\begin{equation*}
			\kern-2.15cm
			\begin{array}{c}
				\displaystyle\bigintssss_{ \mbox{\tiny$\kern1.9cm (t,s)\kern-0.1cm\in\kern-0.1cm C_{\beta_1, \gamma}^{k_1, k_2} [0, 1]$}} \kern-1.95cm\prod^{\alpha_1 - 1,
				\beta_1 - 1} (t) \prod_{j=1}^{k_2}s^{\alpha_2-1}(1-s)^{\beta_2-1}%^{\alpha_2 - 1, \beta_2 - 1} (s)
%%					    \\ \times
					    \Delta^{2 \gamma} (t)
