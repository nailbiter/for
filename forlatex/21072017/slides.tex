...
%%		\end{equation*}
	\item Expanding the ${}_2 F_1 \left( \kern-0.2cm\begin{array}{c}
					\frac{1}{2}-l-\lambda, 2\nu-l-m+1\\
					2 \nu+\lambda-m+\frac{3}{2}
				\end{array}\kern-0.2cm ; \frac{1 - t}{2} \right)$ in series and using the beta integral, we see that $\mbox{RHS}\eqref{eqn:m1-2}/B(\cdots)=$
		Taking the outer integral, we arrive at hypergeometric $_3F_2(;1)$ function which simplifies via Whipple's sum:\begin{equation*}
