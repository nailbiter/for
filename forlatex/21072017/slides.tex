...
\begin{frame}[fragile]
	...
	\begin{textblock*}{\textwidth}(0cm,0.7cm)
	  	\begin{tikzpicture}
			\draw[->,>=angle 90,color=blue,style=very thick] (2.0,4.8) -- node{} (2.0,2.0);
			\node at (2.3,3.4) {\color{red}{\tiny$\begin{array}[]{c}\ell=m=0,\\ \lambda=\mu \end{array}$}};
		\end{tikzpicture}
	\end{textblock*}
