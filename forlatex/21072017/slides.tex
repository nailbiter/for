...
\end{enumerate}}
\begin{frame}{メソッド 2 (1/2)}
			\vspace{-0.2cm}
	\begin{fact}[Carlsonの定理]
		$f$が$\left\{ z\in\mathbb{C}\mid \Re(z)\ge0 \right\}$半平面上に連続で、
		$\left\{ z\in\mathbb{C}\mid\Re(z)>0 \right\}$正則であるとする.
		そうすると、
		\begin{enumerate}
			...
			\item $f$ vanishes on positive integers $\N_+$. でならば
		\end{enumerate}
		$f\equiv0$である.
	\end{fact}
			\vspace{-0.2cm}
