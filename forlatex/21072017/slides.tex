...
\begin{frame}[fragile]%frame TV
	...
	\end{textblock*}
	\begin{textblock*}{0.5\textwidth}(0.55\textwidth,0.2cm)
    			\setulcolor{Blue}
		...
		\begin{equation*}
			\kern-2.15cm
			\begin{array}{c}
				\displaystyle\bigintssss_{ \mbox{\tiny$\kern1.9cm (t,s)\kern-0.1cm\in\kern-0.1cm C_{\beta_1, \gamma}^{k_1, k_2} [0, 1]$}} \kern-1.75cm\textstyle\prod^{\alpha - 1,
