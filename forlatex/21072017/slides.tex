...
\note{TODO (slides):\begin{enumerate}
	\item investigate why LHS in Prop. \ref{exp-stz-gg} and Cor. 1  are non-analytic, while RHS are seemingly analytic
\end{enumerate}
...
\note{
	TODO (slides):\begin{enumerate}
		\item investigate why LHS in Cor. \ref{cor:int-xzy-hh}  are non-analytic, while RHS are seemingly analytic
	\end{enumerate}
	TODO (speech):\begin{enumerate}
	\item 
\end{enumerate}
