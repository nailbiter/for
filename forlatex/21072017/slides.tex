...
\begin{frame}{Method 3 (harder, direct)}
	...
	\begin{enumerate}
		...
		\item Finally, apply the summation formula\begin{equation*}
				\kern-1cm\sum_{i = 0}^{\infty} \frac{(a)_i (1 - a)_i}{2^i i! (d)_i} {}_2 F_1 \left(\kern-0.2cm
				\begin{array}{c}
					  \frac{1 - d - i}{2}, \frac{2 - d - i}{2}\\
					    b + \frac{1}{2}
				    \end{array} \kern-0.2cm; \zeta \right) = 
				    \overbrace{\sum_{j = 0}^{\infty} \frac{(1 - d)_{2 j} \zeta^j}{2^{2 j} j! \left( b +
				    \frac{1}{2} \right)_j}}^{tesime} \overbrace{{}_2 F_1 \left( \kern-0.2cm\begin{array}{c}
					      a, 1 - a\\
					        d - 2 j
					\end{array} \kern-0.2cm; \frac{1}{2} \right) }^{tesime}
