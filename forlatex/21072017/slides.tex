...
\end{enumerate}}
\begin{frame}{Method 4 (easy, direct)}
	We prove the Proposition \ref{prop:int-st-gg} (with $t$ replaced by $-t$) directly\footnote{I am starting to think that this method is the same as Method 1}:
	\begin{enumerate}
