...
\end{frame}
\note{TODO (slides):\begin{enumerate}
\item are the word ``harder/easy'' appropriate?
...
\begin{frame}{Method 4 (easy, direct)\footnote{I am starting to think that this method is the same as Method 1}}
	We prove the Proposition \ref{prop:int-st-gg} directly:
	\begin{enumerate}
		\item We first take the inner integral \cite{kobayashi2011schrodinger}
	\end{enumerate}
\end{frame}
