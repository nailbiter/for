...
\begin{frame}{Method 1 (direct)}
	...
	\begin{enumerate}
		\item Using the property $
				...
				of Gegenbauer polynomials and integration by parts we have $\frac{\mbox{LHS}\eqref{eqn:int-st-gg}}{a(\lambda,l)a(\mu,m)}=$\begin{equation*}
					...
					\kern-0.1cm=a(\lambda,l)a(\mu,m)(-1)^m(-2\nu)_{l+m}\kern-0.2cm\iint_{[-1,1]^2}\kern-0.8cm\myabs{s-t}^{2\nu-l-m}(1-s^2)^{\lambda+n-\frac{1}{2}}(1-t^2)^{\mu+m-\frac{1}{2}};
				\end{equation*}
	\end{enumerate}
\end{frame}
\begin{frame}{Method 1 (direct)}
