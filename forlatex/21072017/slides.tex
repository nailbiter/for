...
\note{TODO (slides):\begin{enumerate}
	\item investigate why LHS in Prop. \ref{prop:exp-stz-gg} is non-analytic, while RHS are seemingly analytic
\end{enumerate}
...
\note{
	TODO (slides):\begin{enumerate}
		\item investigate why LHS in Cor. \ref{cor:int-xzy-hh} is non-analytic, while RHS are seemingly analytic
	\end{enumerate}
	TODO (speech):\begin{enumerate}
	\item 
\end{enumerate}
