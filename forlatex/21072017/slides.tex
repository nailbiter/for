	...
	\begin{enumerate}
		\item Using the property $
				...
				$ of Gegenbauer polynomials and integration by parts we have\begin{equation*}
					\mbox{LHS}\eqref{eqn:int-st-gg}=\frac{\Gamma\left(\lambda+\frac{1}{2}  \right)\Gamma\left( l+2\lambda \right)}{2^{l+m}l!m!\Gamma(2\lambda)\Gamma\left( \lambda+l+\frac{1}{2} \right)}\int_{- 1}^1 \int_{- 1}^1 | s - t |^{2 \nu} \frac{\partial^l}{\partial s^l}(1-s^2)^{\lambda+l-\frac{1}{2}}\frac{\partial^m}{\partial t^m}(1-t^2)^{\mu+m-\frac{1}{2}}
				d s d t
				\end{equation*}
	\end{enumerate}
\end{frame}
