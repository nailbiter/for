								        ...
								        \frac{l + m}{2} - \nu, \frac{m - l}{2} - \nu - \lambda\\
									      \mu + m + 1
									          \end{array} ; z^2 \right). & 
											    ...
											    \end{eqnarray}
    \end{prop}
    命題\ref{prop:exp-st-gg}は命題\ref{exp-stz-gg}において$z=1$としたとその結果である.
\end{frame}
...
%%	\end{equation*}
	\end{example*}
	エルミート多項式とGegenbauer多項式が以下のように関連する:
	%%\vspace{-0.3cm}
	\begin{equation*}
...
\end{versiona}
\begin{frame}
	更に、系\ref{cor:int-xzy-hh}の積分にに$w=s-t$変数変化し、$z=1$をとれば、
	1994から知られている公式
