...
\begin{frame}{Method 1 (direct)}
	...
	\begin{enumerate}
		\item Using the property $
				...
				$ of Gegenbauer polynomials and integration by parts we have\begin{equation*}
					\kern-1cm\mbox{LHS}\eqref{eqn:int-st-gg}=\frac{\left( 2\mu \right)_m\left( 2\lambda \right)_l}
					{2^{l+m}l!m!\left( \mu+\frac{1}{2} \right)_m\left( \lambda+\frac{1}{2} \right)_l}\iint\displaylimits_{[-1,1]^2}
