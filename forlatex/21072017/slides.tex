...
\section{Proof}
\begin{frame}
	Method 1 and Method 3 (presented below) use the following Lemma as a first step:
	...
	\end{lemma*}
	\begin{proof}
		Using the property {\scriptsize\vspace{-1cm}\begin{equation*}
			...
			\end{equation*}}
				of Gegenbauer polynomials and integration by parts we have ${\mbox{LHS}\eqref{eqn:int-st-gg}}/{a(\lambda,l)/a(\mu,m)}=${\scriptsize\begin{equation}
					\begin{array}[]{c}
