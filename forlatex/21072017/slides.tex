		...
		\item 
{
	...
	\begin{textblock*}{0.6\textwidth}(0.4\textwidth,-7.8cm)
		...
		\end{tcolorbox}
	\end{textblock*}
	\begin{textblock*}{0.57\textwidth}(0.5\textwidth,-5.6cm)
		\tiny
		\begin{tcolorbox}[colback=green!10!white,colframe=green]
			\vspace{-0.7cm}
		\begin{equation*}
			\kern-0.45cm
				\textstyle\int_{-1}^1 (1 - t)^{2 \nu+\lambda+\frac{3}{2}} {}_2 F_1 \left( \kern-0.2cm\begin{array}{c}
					\frac{1}{2}-\lambda, 2\nu+1\\
					2 \nu+\lambda+\frac{3}{2}
				\end{array}\kern-0.2cm ; \frac{1 - t}{2} \right)(1-t^2)^{\mu-\frac{1}{2}}dt
			\vspace{-0.35cm}
		\end{equation*}
		\end{tcolorbox}
	\end{textblock*}
