...
\begin{frame}
	Furthermore,
	\begin{cor}
		Taking $\ell=m=0$ in Proposition \ref{prop:exp-stz-gg} and taking $\lambda,\mu\to\infty$ we arrive at:
		\begin{equation*}
			\begin{array}[]{c}
...
\end{frame}
\begin{frame}
	Furthermore, making variable change in \eqref{eqn:int-st-gg} we can arrive at
\end{frame}<++>
\section{Proof}
