...
;;drawing
(define (drawRect l . color)(format #t "\\draw[color=~a] (~f,~f) rectangle (~f,~f);~%" 
                                    (if(null? color)"black"(car color))
                                    (list-ref l 0) (list-ref l 1) (+ (list-ref l 0) (list-ref l 2)) (- (list-ref l 1) (list-ref l 3))))
(define(putLabel text x y . color)(format #t "\\node at (~f,~f) {\\color{~a}{~a}};~%" x y (if(null? color)"black"(car color))  text))
