...
\draw[color=black] (4.2,0.0) rectangle (8.2,-0.5);
\node at (6.2,-0.25) {\color{black}{\tiny Tarasov-Varchenko'03: \color{blue}{3}}};

\draw[color=black] (8.4,0.0) rectangle (12.0,-0.5);
\node at (10.2,-0.25) {\color{black}{\tiny Dotsenko-Fateev'85: \color{blue}{4}}};

\draw[color=red] (2.3,-2.0) rectangle (4.1,-2.5);
...
\draw[->,>=angle 90,color=black] (8.8,-0.5) -- node {} (6.605,-2.0) ; % DF -> S
...
\draw[->,>=angle 90,color=black] (9.9,-0.5) -- node {} (5.912899489957162,-5.922259057356316) ;%DF -> DF'
