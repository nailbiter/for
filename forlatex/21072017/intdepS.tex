...
\draw[->,>=angle 90,color=black] (1.0,-0.5) -- node {T1} (1.490946425395748,-5.90041067935323) ;
\draw[->,>=angle 90,color=black] (3.0057054739713385,-4.2285817953278375) -- node {T2} (1.5573628100792203,-5.93251434108327) ;
\draw[->,>=angle 90,color=red] (3.2,-4.3) -- node {T3} (3.2,-5.914999999999999) ;
\draw[->,>=angle 90,color=black] (3.4394567450999696,-4.180722071773562) -- node {T4} (5.777393604812446,-5.9452027206131675) ;
