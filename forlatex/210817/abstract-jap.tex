...
\item
	$p=1$の場合。\\
	\input{p_equal_to_one_image_diagram_explanation}\footnote{I think we can split the diagram below in half in order to eliminate the large empty space at this page}
	\end{enumerate}
\end{theorem}
