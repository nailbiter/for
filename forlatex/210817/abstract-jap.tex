...
\begin{abstract}
	...
	全て対称性破れ作用素を構成し、分類
	を完成させた。対称性破れ作用素の構成と分類問題\doubt{は}\footnote{here and below \doubt{wavy underline} indicates words which I am not sure in because I might have misread Your handwriting.
...
\end{abstract}
  ...
  \mathbbm{R}^{p + q}),\footnote{I think this comma should be taken away}
	  \end{equation*}
	  と定める。ここで
\begin{equation*}
