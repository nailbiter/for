...
\begin{theorem}[main, {\cite[Thm. 2.3, 3.]{bergeron2016spectrum}}]
	...
	\begin{enumerate}
		\item $\Gamma_{a,b}\subset G:=\mbox{\normalfont SL}_2(\R)$ is cocompact;\label{test}
		...
		\item one (or, equivalently, all) of the following holds:\begin{enumerate}
				...
				\item $(0,0,0,0)$ is the only real root of $x^2-ay^2-bz^2+abw^2=0$; \label{test1}
...
\end{theorem}
\begin{remark}
	Item \ref{test} and \ref{test1}
\end{remark}<++>
\underline{Last time} we have shown the following:
