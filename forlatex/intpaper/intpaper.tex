...
\begin{abstract}
  ...
  generalization\footnote{maybe, ``generalization'' should be in plural (i.e.
...
\begin{corollary}
  ...
  \end{eqnarray}
  where $\delta_0^{\ell} \assign 1$ if $\ell = 0$ and $= 0$ otherwise and
  $\delta_0^m$ is defined similarly.
\end{corollary}
...
\begin{proposition}
  ...
  \begin{eqnarray}
    & \int_{- 1}^1 \int_{- 1}^1 | s + t x |^{2 c - 1} (1 - s^2)^{a - 1} (1 -
...
\begin{proof*}{Proof of Theorem \ref{main-thm}}
  ...
  Then\footnote{maybe, we need a comma here?} the left-hand side of
  ...
  \end{eqnarray}
  where we set
  \[ I_{\ell, m} (x) \assign \int_{- 1}^1 \int_{- 1}^1 | s + tx |^{2 \nu}
  ...
  \begin{eqnarray}
    & I_{\ell, m} (x) = \int_{- 1}^1 \int_{- 1}^1 (1 - s^2)^{\lambda + \ell -
  ...
  \begin{eqnarray}
    & (- 2 \nu)_{\ell + m} x^m \int_{- 1}^1 \int_{- 1}^1 | s + t x |^{2 \nu -
...
\begin{lemma}
  ...
  \begin{eqnarray}
    & \int_{- 1}^1 (1 + tx)^{a - 1} (1 - t^2)^{b - 1} d t = B \left(
...
\begin{lemma}
  ...
  -\mathbbm{N}$. Then\footnote{maybe, we need a comma here?}
...
\begin{proof*}{Proof of Proposition \ref{prop:2}}
  ...
  $_2 F_1$ shows
  \begin{eqnarray}
    & \int_{- 1}^1 (s + x)_+^{2 c - 1} (1 - s^2)^{a - 1} d s = 2^{a - 1} B (2
  ...
  \begin{eqnarray}
    & 2 \int_{- 1}^1 \int_{- 1}^1 (s + tx)_+^{2 c - 1} (1 - s^2)^{a - 1} (1 -
    t^2)^{b - 1} d s d t &  \nonumber\\
    & = 2^a B (2 c, a) \int_{- 1}^1 (1 + tx)^{2 c + a - 1} _2 F_1 \left(
    \begin{array}{c}
      1 - a, a\\
      2 c + a
  ...
  \begin{eqnarray}
    ...
    \int_{- 1}^1 (1 + t x)^{2 c + a - 1 + i} (1 - t^2)^{b - 1} d t. & 
    \nonumber
  \end{eqnarray}
  ...
  and $d = 2 c + a$\footnote{maybe, we need a comma here?} and from the
...
\begin{corollary}
  ...
  even.\footnote{should we change $x - zy$ to $x + zy$ here?}
  \begin{eqnarray}
...
\begin{example}
  ...
  \begin{eqnarray}
    & \frac{1}{(2 \pi)^{n / 2}} \int_{\mathbbm{R}^n} \prod_{i = 1}^n e^{-
...
\begin{example}
  ...
  \ref{main-thm} with $\ell = m = 0$, $z = 1$ and $\lambda = \mu$. 
\end{example}
...
\begin{example}
  ...
  \end{eqnarray}
  This coincides with the special case of Theorem \ref{main-thm} with $(\ell,
  m, z, \mu) = \left( 0, 0, 1, \frac{1}{2} \right)$.
\end{example}
...
\begin{thebibliography}{1}
  ...
  integral.{\newblock} \tmtextit{Norsk Mat. Tidsskr.}, vol. 26, pages 71--78,
  1944.{\newblock}
