...
\begin{example}
  ...
  \begin{eqnarray}
    & \frac{1}{2^{4 \lambda + 2 \nu}} \displaystyle\int_{- 1}^1 \displaystyle\int_{- 1}^1 (1 -
...
\begin{example}
  ...
  \begin{eqnarray}
    & \frac{1}{2^{\lambda + \mu}} \left( \displaystyle\int \displaystyle\int_{0 \leqslant s < t
...
\begin{example}
  ...
  equation
  \begin{eqnarray}
    & 2^{2 - 2 \lambda - 2 \mu} \displaystyle\int_{- 1}^1 \displaystyle\displaystyle\int_{- 1}^1 (1 - s^2)^{\lambda
