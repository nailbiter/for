...
\title{On certain integral formulae concerning two Gegenbauer polynomials}
...
{\cite{kobayashi2011schrodinger}}?}\footnote{maybe, we should switch to the {\ttfamily alpha} style
for bibliography labels (i.e., not [1], [2], [3], but [TV03], [KM11], [M04] etc.)?}
