...
\begin{example}
	...
	\[\begin{bmatrix}\dot{x}\\\dot{y}\end{bmatrix}=
		\begin{bmatrix}1+P(t)e^{-t^2}&(Q-P)(t)e^{-t^2}/2\\0&-1+Q(t)e^{-t^2}\end{bmatrix}
	\begin{bmatrix}{x}\\{y}\end{bmatrix},\]
	where $P(t)$ and $Q(t)$ are arbitrary polynomials in $t$.

	Note, that both the original matrix $\mysbra{\begin{smallmatrix}1&0\\0&-1\end{smallmatrix}}$ and perturbation we've applied
	$\mysbra{\begin{smallmatrix}P(t)&(Q-P)(t)/2\\0&Q(t)\end{smallmatrix}}e^{-t^2}$ commute.
