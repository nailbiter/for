...
%%1. біля свого прізвища краще поставте a,*, а біля мого b.
%%3. в формулах (1) ви використовуєте exp{...}, а в решті формул e^{...}. Думаю, що в цій формулі варто змінити формат а такий як у всьому тексті.
%%4. Параграф про Коппела (рядок 11) пропоную переписати так: One of the first monograph entirely devoted to the exponential dichotomy was (is?) a book of Coppel [1]. It contains .....
%%5. В Corollary 3 (рядок 119) пропоную сталу матрицю с позначати великою літерою С, а не малою.
%%6. Рядок 137, зайвий пробіл між differential equation і комою.
%%7. Посилання [9], монографія А.М.Самойленка насправді 1991 року. Я бачив по посиланню, яке ви дали в списку літератури, зазаначено, що книга 2012 р. Але це не так. Якщо її шукати в інших місцях (на амазоні, навіть), то там зазначається, що вона 1991 р.
