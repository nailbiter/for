...
The concept of exponential dichotomy plays an important role both in theory and applications. For instance
 ...
 One of the first monographes entirely devoted to the subject of exponential dichotomy was the book of Coppel \cite{coppel1978dichotomies}.
...
\begin{example}
	...
	for general $P$ and $Q$,
	as any of them requires the supremum-norm $\mynorm{B(t)}_\infty$ of perturbation be smaller than some particular value,
