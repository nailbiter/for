...
%FIXME: Після означень варто наголосити на важливості дослідження. Щось типу такого: 
...
%%7. В четверту секцію Cor. and Examples варто обов'язково включити приклад, який ілюструє використання основної теореми та її переваги над відомими до цього результатами. Пропоную вибрати збурення таке, що воно прямувало до нуля при t\to\+infty i t\to\-infty. І продемонструвати, що у випадку виконання додаткових умов теореми (про комутацію) дихотомія зберігаєтсья на всій осі, а за результатами Палмера (1984) - лише на півосях.
