...
\begin{todolist}
	...
	\item[item] Copy of both side of the ``Residence card'';
	\item[item] Certificate of Receipt of a Scholarship (学振奨学金、コーピ、日本語);
	\item[\done] Certificate of student registration (コーピ、日本語);
	\item[item] Certificate of residence (日本語);
	\item[item] Certification of the Balance of Deposit (2口座、英語);4
	\item[item] Copy of the last page of passbook (コーピ、日本語).
\end{todolist}
