...
%begin  研究の背景＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	...
	\bibitem{CKOP11}J. L. Clerc, T. Kobayashi, {{\O}}rsted, B., Pevzner, M. (2011). \myquotes{Generalized Bernstein–Reznikov integrals}. Mathematische Annalen, 349(2), 395-431.
	\bibitem{GGP12}  W. T. Gan, B. H. Gross, and D. Prasad. \myquotes{Sur les conjectures de Gross et Prasad}. Ast\'erisque, 2012.
	\bibitem{Juh09}  A. Juhl. \myquotes{Families of conformally covariant differential operators, Q-curvature and holography}, volume 275. Birkh\"auser Basel, 2009.
	\bibitem{KS15}  T. Kobayashi and B. Speh. \myquotes{Symmetry breaking for representations of rank one orthogonal groups}. Memoirs of the American Mathematical Society, 238(1126), 2015. 
	\bibitem{KP16b}T. Kobayashi and M. Pevzner, \myquotes{Differential symmetry breaking operators. II. Rankin-Cohen operators for symmetric pairs}, Selecta Mathematica (N.S.) 22 (2016), no. 2, 
		847-911.
	\bibitem{HT93} R. E. Howe, and E.-C. Tan. \myquotes{Homogeneous functions on light cones: the infinitesimal structure of some degenerate principal series representations.} 
		Bulletin of the American Mathematical Society 28.1 (1993): 1-74.
	\bibitem{KOSS15}T. Kobayashi, B. {{\O}}rsted, P. Somberg, V. Sou{{\v c}}ek (2015). \myquotes{Branching laws for Verma modules and applications in parabolic geometry. I.} Advances in Mathematics, 285, 1796-1852.
	\end{thebibliography}
%end  研究の背景 ＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
}
...
%begin  現在までの研究状況＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
	...
	was shown to be interacting with numerous mathematical objects and theories (e.g. Knapp-Stein operators, de-Sitter spaces, harmonic analysis, branching laws of complementary series, etc.).
	For higher $q$ one can immediately point out the special case $(p,q)=(1,2)$ as being equivalent to finding invariant trilinear forms for representations of $SL_2$, as one might see latter as 
	SBOs of $O(2,2)\supset O(2,1)$.\\
	Of particular importance are so-called differential SBOs. In special case $q=1$
	...
	I gave complete classification of $P'\\G/P$ orbit decomposition of flag variety $G/P$ of $G$ under the action of $P'$ (maximal parabolic subgroup of $G'$).
...
Their work was immediately followed by Clerk (France), {\O}rsted (Denmark), M\"ullers and Gomez (USA) among others.
...
following way:\begin{enumerate}
	\item One first classifies $P'\backslash G/P$ cosets so to understand what support can SBOs have;
	\item For values of parameters ``regular'' enough one constructs several families of SBOs holomorphically dependent on parameters having support in each set as predicted on previous step;
	\item One then determines location of poles for every family and normalizes them; after normalization is done one has to determine the support of residues;
	\item One proves that constructed families exhaust the space of SBOs.
\end{enumerate}
