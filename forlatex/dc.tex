...
The general problem of symmetry breaking between reductive groups,
besides being fundamental in representation theory, is also known to interact with geometry, PDE, real analysis and number theory.

	\begin{thebibliography}{99}
\bibitem[Juh09]{Juh09}  A. Juhl, \myquotes{Families of conformally covariant differential operators, Q-curvature and holography}, 275, Birkh\"auser Basel, 2009.
\bibitem[CK{{\O}}P11]{CKOP11}J. L. Clerc, T. Kobayashi, B. {{\O}}rsted, M. Pevzner, \myquotes{Generalized Bernstein-Reznikov integrals}, Mathematische Annalen, Springer, 349(2), pp. 395--431, 2011.
	\bibitem[KS15]{KS15}  T. Kobayashi and B. Speh. \myquotes{Symmetry breaking for representations of rank one orthogonal groups},
	Memoirs of the A. M. S., A. M. S., 238(1126), 2015. 
\bibitem[KP16]{KP16b}T. Kobayashi and M. Pevzner, \myquotes{Differential symmetry breaking operators. II. Rankin-Cohen operators for symmetric pairs}, Selecta Mathematica (N.S.), Springer, 22(2), 
		pp. 847--911, 2015.
...
following way:\begin{enumerate}
	...
	\item For values of parameters regular enough one constructs several families of SBOs holomorphically dependent on parameters having support in each set as predicted in the previous step
		(note that this corresponds to Stage C of T. Kobayashi's program outlined in \cite{K15});
	...
	\item One proves that constructed (normalized) families exhaust the space of SBOs (this part is also highly nontrivial, but heuristically, if normalization was done in the ``optimal'' way, it
		turns out to work out), thus obtaining basis for SBO space for every value of parameters (this gives basis of SBO space $\mbox{Hom}_{G'}\left( I\left( \lambda \right),J\left( \nu \right) \right)$ Stage B of \cite{K15});
...
modulo some minor technical issues
...
%%	\bibitem{GGP12}  W. T. Gan, B. H. Gross, and D. Prasad, \myquotes{Sur les conjectures de Gross et Prasad}, Ast\'erisque, {Soci{\'e}t{\'e} Math{\'e}matique de France}, 346, 2012.
	\bibitem[HT93]{HT93} R. E. Howe and E.-C. Tan, \myquotes{Homogeneous functions on light cones: the infinitesimal structure of some degenerate principal series representations},
	Bulletin of the A. M. S., A. M. S., 28(1), pp. 1--74, 1993.
\bibitem[GGP12]{GGP12}  W. T. Gan, B. H. Gross, and D. Prasad, \myquotes{Sur les conjectures de Gross et Prasad}, Ast\'erisque, {Soci{\'e}t{\'e} Math{\'e}matique de France}, 346, 2012.
%%	\bibitem{KS15}  T. Kobayashi and B. Speh. \myquotes{Symmetry breaking for representations of rank one orthogonal groups},
%%		Memoirs of the A. M. S., A. M. S., 238(1126), 2015. 
%%\bibitem[K{{\O}}SS15]{KOSS15}T. Kobayashi, B. {{\O}}rsted, P. Somberg, V. Sou{{\v c}}ek, \myquotes{Branching laws for Verma modules and applications in parabolic geometry. I}, Advances in Mathematics,
%%		Elsevier, 285, pp. 1796--1852, 2015.
		\bibitem[K15]{K15}T. Kobayashi,
		\myquotes{A program for branching problems in the representation theory of real reductive groups}, Representations of Lie Groups: In Honor of David A. Vogan, Jr. on his 60th Birthday,
		 Birkh\"auser, 312, pp. 277--322., 2015.
	\end{thebibliography}
