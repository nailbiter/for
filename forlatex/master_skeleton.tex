...
%%  denominator is non-zero) we have
  ...
  \end{equation*}
  for any $b\in\R^{p,q}$ such that $b_p=0$ and any $x\in\R^{p,q}$ such that $1-2\Q(b,x)+\Q(x)\Q(b)\neq0$. Here we let
  $\Q(b,x):=b^tI_{p,q}x$.
\end{definition}
