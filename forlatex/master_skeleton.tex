...
Which allows us to consider $K'$-submodules (and in particular, $G'$-submodules) of $J(\nu)$ as subsets of $\mathfrak{I}$. Using this identification, we have:
\begin{theorem}[images of SBOs]
	The image of regular SBO $R_{\lambda,\nu}^X$ is full unless $(\lambda,\nu)\in\Z$. In the latter case, they are as follows
	...
	\begin{enumerate}
		\item Suppose $p\in2\Z+1$ and $q\in2\Z$. Then, if $\nu\in2\Z,0<\nu<n-1$, $R_{\lambda,\nu}^X$ is onto. Otherwise,
			\begin{figure}[H]
		\hskip-1.1cm\noindent\begin{tabular}{@{}r@{}cccc}
					&$\mybra{//\cup\backslash\backslash}^c$ & $\backslash\backslash-//$  & $//\cap\backslash\backslash,
					k\ge l$&{\normalfont CS}\\[15pt]
					$\even\ni\nu\leq0$&\socleA{\mycolo A^0(-\nu)}{A^3(-\nu)}&\socleA{\mycolo A^0(-\nu)}{A^3(-\nu)}&\socleA{ A^0(-\nu)}{A^3(-\nu)}&
					\socleA{ A^0(-\nu)}{A^3(-\nu)}
				\\[15pt]
				$\odd\ni\nu\leq\frac{n-3}{2}$&\socleAP{\mycolo A^{12}(-\nu)}{A^1(-\nu)}{\mycolo A^2(-\nu)}&
				\socleAP{ \mycolo A^{12}(-\nu)}{A^1(-\nu)}{ A^2(-\nu)}&\socleAP{ A^{12}(-\nu)}{A^1(-\nu)}{ A^2(-\nu)}&\socleAP{ A^{12}(-\nu)}{A^1(-\nu)}{ A^2(-\nu)}\\
				\end{tabular}
			\end{figure}
		\begin{figure}[H]
		\hskip-1.0cm\noindent
		\begin{tabular}{@{}r@{}ccc}
				&$\mybra{//\cup\backslash\backslash}^c$ & $//\cap\backslash\backslash,
				k=l$&{\normalfont CS}\\[15pt]
				$\odd\ni\nu=\frac{n-1}{2}$&\socleP{A^1(-\nu)}{\mycolo A^2(-\nu)}&\socleP{A^1(-\nu)}{A^2(-\nu)}&\socleP{A^1(-\nu)}{A^2(-\nu)}
			\\[15pt]
		\end{tabular}
		\end{figure}
		\begin{figure}[H]
		\hskip-1.1cm\noindent\begin{tabular}{@{}r@{}cccc}
					&$\mybra{//\cup\backslash\backslash}^c$ & $//-\backslash\backslash$  & $//\cap\backslash\backslash,
					k\le l$&{\normalfont CS}\\[15pt]
					$\even\ni\nu\ge n-1$&\socleA{\mycolo A^3(-\nu)}{\mycolo A^0(-\nu)}&\socleA{\mycolo A^3(-\nu)}{\mycolo A^0(-\nu)}&\socleA{\mycolo A^3(-\nu)}{ A^0(-\nu)}&
					\socleA{A^3(-\nu)}{ A^0(-\nu)}
				\\[15pt]
	$\odd\ni\nu\ge\frac{n+1}{2}$&\soclePA{A^1(\nu-n')}{\mycolo A^2(\nu-n')}{A^{12}(\nu-n')}&\soclePA{A^1(\nu-n')}{A^2(\nu-n')}{A^{12}(\nu-n')}&\soclePA{A^1(\nu-n')}{A^2(\nu-n')}{A^{12}(\nu-n')}
		&\soclePA{A^1(\nu-n')}{A^2(\nu-n')}{A^{12}(\nu-n')}
				\end{tabular}
		\end{figure}
	\end{enumerate}
...
%FIXME
	%knapp-stein normalization
	%k-speh, k-orsted references
